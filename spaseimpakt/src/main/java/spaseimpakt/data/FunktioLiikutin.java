...
public class FunktioLiikutin implements Liikutin {
    ...
    /**
     * Konstruktori, jolla luodaan uusi liikutin, joka antaa koordinaatteja
     * annetun neljännen asteen funktion mukaisesti
     *
     * @param x liikuteltavan olion x-koordinaatti alussa
     * @param dx nopeus, jolla alus liikkuu x-suunnassa (pikseliä/askel)
     * @param kertoimet viisialkioinen taulukko [a, b, c, d, e], joka määrittää
     * muotoa ax⁴+bx³+cx²+dx+e olevan funktion
     */
